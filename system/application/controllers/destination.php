...
class Destination extends Controller {
	...
	function fbtest()
	{
		...
		$fbOAuthUrl = "https://graph.facebook.com/oauth/authorize?client_id=".FBAPPID."&redirect_uri=".site_url('destination/fbtest/')."#/&scope=email,user_birthday,user_hometown";
